    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-4" style="padding-right:0px;padding-left:0px">
            <input type="hidden" class="form-control input-sm" name="id_file" value="<?php echo $record['id'];?>">
            <input type="file" class="form-control input-sm" name="file_file" value="<?php echo $record['img'];?>">
            <!-- <button type="submit" class="btn btn-default">UPLOAD</button> -->
         
        </div>
        <div class="col-sm-2" style="padding-left:0px">
          <button type="submit" class="btn btn-default btn-block btn-sm" name="submit">UPLOAD</button>
        </div>
        <div class="col-sm-3"></div>
      </div>
      </form>
        ...
        <div class="col-sm-6">
            <div class="card">
                <div class="card-image">
                    <img class="img-responsive" src="<?php echo base_url();?>uploads/<?php echo $record['img'];?>">
